        ...
        public static void Seed(this ModelBuilder builder)
        {
            ...
            builder.Entity<BookAuthor>().HasData(
                new BookAuthor
                {
                    ...
                    BookId = new Guid("8A6EE85F-A71A-4075-BF06-B08B418CB0D8")
                },
                new BookAuthor
                {
                    AuthorId = new Guid("152BA060-CE13-4997-A8D1-EFE6AEF1EA98"),
                    BookId = new Guid("A43AF29D-6860-4949-A364-B373FC34F0D8")
                },
                new BookAuthor
                {
                    AuthorId = new Guid("BEF93CE5-9BF1-4B19-A6A8-5C7DFF1E24B4"),
                    BookId = new Guid("2FE13138-4570-4818-889F-A6113E6AF38C")
                },
                new BookAuthor
                {
                    AuthorId = new Guid("F2997F3C-6C2F-4F6A-9D23-3AEA8DB4AD67"),
                    BookId = new Guid("3A0A19F3-E347-41B7-AB41-FADECBB7A767")
                }
            );
        }
    }
